...
if __name__ == "__main__":
    ...
    x3 = [56, 66, 77, 86.5, 96.5, 104.4, 113, 120,    128.2, 134.7, 141.5, 147, 154, 159.8, 165.5, 170.1, 175, 179, 183.5, 187.1]
    y4 = [0, 0.5, 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5, 5.5, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10.5, 11, 11.5]
    x4 = [70.5, 81.3, 94.2, 105.5, 117.1, 126.3, 136, 144, 152.7, 160, 167.7, 174.6, 182, 188.2, 195, 200.5, 207, 211.4, 216.5, 220.5, 225, 229, 233.3, 236.7]
